...
class ConfigManager:
    ...
    def _parse_device_config(self, device_name, config):
        ...
        if eigrp_match:
            ...
            # FIX: Handle indented network statements
        ...
        if ospf_match:
            ...
            # FIX: Handle leading spaces in network statements
